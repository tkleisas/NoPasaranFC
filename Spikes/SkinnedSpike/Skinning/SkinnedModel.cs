...
public class SkinnedModel
{
    ...
    /// <summary>Fills pose with the clip sampled at time (loops). Starts from bind pose, overrides animated channels.</summary>
    public void SampleClip(AnimationClip clip, float time, NodePose[] pose)
    {
        GetBindPose(pose);
