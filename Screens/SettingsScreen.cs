...
namespace NoPasaranFC.Screens
{
    public class SettingsScreen : Screen
    {
        ...
        private static readonly string[] _venueOptions = new[] { "Bahramis", "Sperchogeia", "Sfageia", "Kerasoulia", "Soulinari", "Random" };
        ...
        private void AdjustValue(int direction)
        {
            ...
            switch (setting)
            {
                ...
                case SettingType.CameraZoom:
                    _settings.CameraZoom = Math.Clamp(_settings.CameraZoom + direction * 0.1f, 0.3f, 3f);
                    _database.SaveSettings(_settings);
                    break;
